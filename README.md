...
`npm run validate:qss` uses ignored local XML/CSV reference files under `private/reference/` when present. `npm run validate:lbic` checks ignored LBIC XMLs under `private/reference/lbic/` structurally; it does not claim vendor numerical parity.
