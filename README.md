...
|---|---|---|---|
| `DITMeasurement` | Dit / COCOS | Vcpd/Vsb, Minimum Dit, optional Midgap Dit, Qsc, Qtot, Cox/EOT | Standard COCOS remains profile-scoped; `DIT-RESULT-INITIAL-001` validates initial VDark/Initial Qc bookkeeping; COCOS-II remains inferred |
