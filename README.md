...
|---|---|---|---|
| `DITMeasurement` | Dit / COCOS | Vcpd/Vsb, Minimum Dit, optional Midgap Dit, Qsc, Qtot, Cox/EOT | `DIT-RESULT-INITIAL-001` validates direct/bookkeeping result fields; `DIT-RESULT-STANDARD-DLL-002` validates current-DLL Standard-COCOS downstream results; `DIT-RESULT-COCOSII-DLL-003` validates the recovered current-DLL COCOS-II Dit/Qit path through controlled vendor probes; Analyzer Ge/PCHIP remain separate |
