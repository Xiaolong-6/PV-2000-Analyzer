...
|---|---|---|---|
| `DITMeasurement` | Dit / COCOS | Vcpd/Vsb curves, discrete Minimum Dit, optional Midgap Dit, Qsc, Qtot, Cox/EOT, site filtering and spatial context | Standard COCOS remains profile-scoped; `DIT-RESULT-INITIAL-001` validates initial VDark, corrected final-result VLight and Initial Qc; N-type final-result Vsb and downstream flatband/Dit remain diagnostic; COCOS-II inferred |
