...
Open XML
  ...
  -> measurement registry
      ...
      -> JZeroMeasurement    -> Emitter J0 map module
...
- `src/modules/jzero.js` — Emitter J0 two-intensity map parser, Basore/Smax/Implied-Voc compatibility calculations and map/distribution UI.
