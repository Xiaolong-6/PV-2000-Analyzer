  ...
  function render(host,d,a){
    ...
    function renderShell(){
      ...
      host.innerHTML=`<div class="module-grid qss-module"><aside class="side">
        ...
        <details class="panel"><summary>Algorithm notes ${help('Coordinates are reconstructed from MapPattern using ascending Y then ascending X, with the RoundWafer diameter reduced by the XML EdgeExclusion before applying the strict circular boundary. Implied Voc uses the measured chuck temperature plus the documented PV-2000-compatibility ni(T) model. Reference-validation evidence remains in the project documentation.')}</summary></details>
