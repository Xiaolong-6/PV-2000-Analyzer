(function(root){
  ...
  function render(host,d,a){
    ...
    function shell(){
      ...
      </aside><section class="plots"><div class="panel chart"><header><b>Wafer map</b><span class="grow"></span><select id="jMetric">${options()}</select><select id="jMapMode"><option value="filled">Filled</option><option value="points">Points</option></select>${PV.plot.axisControls('jMapAxes')}<button id="jExportMap">Export</button></header><div class="canvas-wrap"><canvas id="jMap"></canvas></div></div></section><section class="plots"><div class="panel chart"><header><b>Distribution</b><span class="grow"></span>${PV.plot.axisControls('jHistAxes',{distribution:true,swapped:histSwapped})}${PV.plot.binControls('jHistBins',histBins)}<button id="jExportHist">Export</button></header><div class="canvas-wrap"><canvas id="jHist"></canvas></div></div></section></div>`;
