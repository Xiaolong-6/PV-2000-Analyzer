(function(root){
  ...
  function drawMap(canvas,d,metric,selected,scaleMode,onSelect,zoom,onZoom){
    ...
    const b=GEO.bounds(coords),
      ...
      rawX=pseudo?[-pseudo.nominal.halfWidth*1.06,pseudo.nominal.halfWidth*1.06]:[b.xmin-dx/2,b.xmax+dx/2],
      rawY=pseudo?[-pseudo.nominal.halfHeight*1.06,pseudo.nominal.halfHeight*1.06]:[b.ymin-dy/2,b.ymax+dy/2],
      availW=W-p.l-p.r,
      availH=H-p.t-p.b,
